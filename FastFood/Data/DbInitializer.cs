        ...
        public static Dictionary<string, Category> Categories
        {
            get
            {
                if (categories == null)
                {
                    ...
                    {
                        new Category { CategoryName = "Burger", Description="All Burger Foods", CImageUrl = "http://imgh.us/juiceL.jpg" },
                        new Category { CategoryName = "Pizza", Description="All Pizza Foods", CImageUrl = "http://imgh.us/juiceL.jpg" },
                        new Category { CategoryName = "Drinks", Description="All Drinks", CImageUrl = "http://imgh.us/juiceL.jpg" }
